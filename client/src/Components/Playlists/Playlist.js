        ...
        <div className="bg-iGray2 pt-[52px] pl-9 pb-[114px] pr-7">
          {listData.length > 0 && (
            <>
              <div className="flex flex-row justify-between">
                <h1 className="text-[30px] font-medium">Newly Added</h1>
                <h5 className="underline font-medium text-[16px] text-iBlack1"></h5>
              </div>
          ...
          <div>
            <div className="flex flex-row justify-between my-7">
              ...
              <button
                onClick={() =>
                  HandelSeeAll({ path: "new-release", title: "New releases" })
                }
                className="underline font-medium text-[16px] text-iBlack1 mt-[28px]"
              >
                See All
              </button>
            </div>
          ...
          <div>
            <div className="flex flex-row justify-between my-7">
              ...
              <button
                onClick={() =>
                  HandelSeeAll({ path: "top-chart", title: "Top charts" })
                }
                className="underline font-medium text-[16px] text-iBlack1 mt-[28px]"
              >
                See All
              ...
              <button
                onClick={() =>
                  HandelSeeAll({
                    ...
                    title: "Featured playlists Based on Mood",
                  })
                }
                className="underline font-medium text-[16px] text-iBlack1 mt-[28px]"
              >
...
const data1 = [
  ...
  { id: 4, src: Card47, playlist: "EveryThing from Taylor ", album: "Weekend" },
  {
    id: 5,
    src: Card14,
    playlist: " Ariana Grande This Side",
    album: "Weekend",
  },
...
const data2 = [
  {
    id: 1,
    src: Card11,
    playlist: "Good Music for Bad Days ",
    album: "Weekend",
  },
  {
    id: 2,
