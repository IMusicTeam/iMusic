  ...
  return (
    <div className="flex flex-row items-center justify-center h-[100px] w-full bg-iWhite bottom-0">
      <div className="flex gap-[50px] text-iBlue text-base">
        ...
        <div className="flex flex-row justify-between gap-[60px] text-[20px] text-iBlue mt-6">
        <span>FAQ</span>
        ...
        <span>Cookie Policy</span>
            ...
            <div className="flex flex-row justify-center text-center -ml-[250px] text-iOrange">
               &#169;iMusic
            </div>
        </div>
      </div>
