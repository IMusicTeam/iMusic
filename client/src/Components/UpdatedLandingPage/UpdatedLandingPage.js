    ...
    return (
        <div className="w-full h-full bg-iLightBlue">
            ...
            <div className="relative items-center text-center transition ease-in-out delay-150 hover:-translate-y-2 hover:scale-105 duration-400">
                ...
                <div className="4xl:text-[50px] 4xl:left-0 3xl:text-[40px] text-iWhite font-medium w-[490px] h-[80px] absolute top-[175px] 3xl:-left-[46px] right-[75px] leading-none 13mac:text-[37px] 13mac:-left-[70px] 2xl:text-[40px] 2xl:-left-[55px] 1.5xl:text-[33px] 1.5xl:-left-[80px] 1.5xl:top-[120px] 1xl:text-[33px] 1xl:-left-[80px] 1xl:top-[120px] 5xl:text-[35px] 5xl:-left-[75px] 5xl:top-[120px] xl:text-[30px] xl:-left-[80px] xl:top-[120px]">Music Possibilities</div>
                ...
                <div className="4xl:text-[50px] 3xl:text-[40px] text-iWhite font-medium w-[490px] h-[80px] absolute top-[175px] 3xl:-left-[45px] right-[75px] leading-none 13mac:text-[37px] 13mac:-left-[75px] 2xl:text-[40px] 2xl:-left-[65px] 1.5xl:text-[33px] 1.5xl:-left-[80px] 1.5xl:top-[120px] 1xl:text-[33px] 1xl:-left-[80px] 1xl:top-[120px] 5xl:text-[33px] 5xl:-left-[90px] 5xl:top-[120px] xl:text-[30px] xl:-left-[85px] xl:top-[120px]">Revolution</div>
